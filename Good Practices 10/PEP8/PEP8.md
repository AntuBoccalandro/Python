...
En breve definiremos que es PEP8, pero primero es mejor tener refrescado el Zen de Python, que tiene mucho que ver con los estándares de código Python. Puedes acceder a él mediante el REPL de Python escribiendo: `import this`.
