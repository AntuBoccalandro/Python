...
# Operadores Lógicos
a = b = 10
a and b # Evalúa si el ambas son veraderas. Las dos condiciones deben ser True para que el resusltado sea True.
not b   # Si un valor es True = False y Flase = True.
